...
const randomMsg = [
  ...
  '撸码与 duang 不可兼得',
  '不要停下来啊（指写文档）',
  '可能抄到最后你会发现，大家的机器人重合度高的离谱',
  '塔塔开，一自摸塔塔开',
  '如果文档看不懂，那么你没有看懂文档',
  '你这 bot 是金子做的还是服务器是金子做的',
  'fut.set_result("KEEP_ALIVE")',
  '欢迎来到 林汐食用文档！这里是治疗低血压的最好的地方',
  '年轻的开发者哟，你掉的是这个 VSCode 还是 PyCharm 呢',
  '因为社区都去写自己的 bot 了，所以文档咕了',
  '因为社区都去打崩铁了，所以文档咕了',
  '因为社区都去咖啡屋看热闹了，所以文档咕了',
  '因为社区都想咕咕咕，所以文档咕了',
  'Literal[2122222222111221212111111111112]',
  'ModuleNotFoundError: No module named \'SoraBot\'', // prettier-ignore
  '看看你的 type checker',
  '什么超级魔法',
  'async def f(): aiohttp.sleep(10)',
  '不要以为加个 async 就是异步了',
...
onMounted(() => {
  random.value = randomMsg[Math.floor(Math.random() * randomMsg.length)]
})
    ...
    <template #doc-after>
      <div class="doc-after">
        ...
        <div class="ccbyncsa">
          ...
          协议进行共享，详情见
          <a href="https://github.com/netsora/SoraBot-website" target="_blank">README</a>。
        </div>
      </div>
    </template>
    <template #not-found>
